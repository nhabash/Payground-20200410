...
export default class TypeCategoryType {
    ...
    getName() { return 'TypeCategoryType'; }
    ...
    updateValues(entry) {
        ...
        if (this.tagsArray !== null && this.tagsArray !== undefined) {
            this.tagsArray.forEach(t => { t.updateValues(entry) });
        }
    }
    ...
    deepEqual(item) {
        ...
        if (this.rightTypeCode === item.rightTypeCode &&
            ...
            this.tagsArray.forEach(t => item.tagsArray.forEach(it => {
